...
{	
	...
	float4 v[4];
	v[0] = float4(0.0f, -halfHeight, -halfWidth, 1.0f);
	v[1] = float4(0.0f, -halfHeight, +halfWidth, 1.0f);
	v[2] = float4(0.0f, +halfHeight, -halfWidth, 1.0f);
	v[3] = float4(0.0f, +halfHeight, +halfWidth, 1.0f);
	//
