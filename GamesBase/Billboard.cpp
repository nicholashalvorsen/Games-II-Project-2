...
void BillBoard::buildVB(const D3DXVECTOR3 centers[], const float width, const float height)
{
	BillboardVertex* v = new BillboardVertex[num];
    ...
    vbd.ByteWidth = sizeof(BillboardVertex) * num;
...
void BillBoard::buildFX()
{
	...
	HRESULT hr = 0;
	hr = D3DX10CreateEffectFromFile(L"billboard.fx", 0, 0, 
...
void BillBoard::buildShaderResourceView(std::wstring filename)
{
